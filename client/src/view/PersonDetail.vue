<template>
  <div>
    <Header leftIcon="chevron_left" rightIcon content="个人信息" color @leftClick="goback"></Header>
    <div class="all-chat">
      ...
      <div class="group-list">
        <mu-list>
          ...
          <mu-list-item button :ripple="false" @click="events = !events">
            <mu-list-item-title>注册时间</mu-list-item-title>
...
export default {
  ...
  computed: {
    ...mapState(["lookUserInfo", "userInfo"])
  },
